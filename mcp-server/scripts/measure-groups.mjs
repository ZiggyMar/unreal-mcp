...
const GROUPS = ["core", "cpp", "edit", "ui", "materials", "data", "scene", "maintenance"];
...
function renderRecord(rows, baseline, everything, featureSet) {
...
async function main() {
  ...
  if (process.argv.includes("--write")) {
    writeFileSync(RECORD, renderRecord(rows, baseline.tokens, everything.tokens, featureSet), "utf8");
